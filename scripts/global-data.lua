...
function global_data.refresh()
    ...
    for name, proto in pairs(prototypes.get_item_filtered(filters)) do
    ...
    all_trash.max_slot = i
    all.max_slot = i
    storage.trash_all_items = all_trash
    storage.all_items = all
end
